...
public class AiCrewMemberRemovalChooserTest
{
    ...
    public void setupTest() throws PWCGException
    {
        ...
        company = PWCGContext.getInstance().getCompanyManager().getCompany(TestIdentifiers.TEST_RUSSIAN_COMPANY_ID); 

         Mockito.when(companyMember1.getRank()).thenReturn("Kapitan");
         Mockito.when(companyMember1.getSerialNumber()).thenReturn(SerialNumber.AI_STARTING_SERIAL_NUMBER+1);
        
         Mockito.when(companyMember2.getRank()).thenReturn("Starshyi leyitenant");
         Mockito.when(companyMember2.getSerialNumber()).thenReturn(SerialNumber.AI_STARTING_SERIAL_NUMBER+2);
        
         Mockito.when(companyMember3.getRank()).thenReturn("Leyitenant");
         ...
         Mockito.when(companyMember5.getRank()).thenReturn("Serzhant");
         Mockito.when(companyMember5.getSerialNumber()).thenReturn(SerialNumber.AI_STARTING_SERIAL_NUMBER+5);

         Mockito.when(companyMember6.getRank()).thenReturn("Yefreytor");
    ...
    public void testRemoveSameRank() throws PWCGException
    {
        ...
        CrewMember companyMemberRemoved = chooser.findAiCrewMemberToRemove("Serzhant", TestIdentifiers.TEST_RUSSIAN_COMPANY_ID);
    ...
    public void testRemoveSimilarRank() throws PWCGException
    {
        ...
        AiCrewMemberRemovalChooser chooser = new AiCrewMemberRemovalChooser(campaign);
        CrewMember companyMemberRemoved = chooser.findAiCrewMemberToRemove("Yefreytor", 10131132);
    ...
    public void testRemoveAnyNonCommandRank() throws PWCGException
    {
        ...
        AiCrewMemberRemovalChooser chooser = new AiCrewMemberRemovalChooser(campaign);
        CrewMember companyMemberRemoved = chooser.findAiCrewMemberToRemove("Yefreytor", TestIdentifiers.TEST_RUSSIAN_COMPANY_ID);
    ...
    public void testCommanderRemoved() throws PWCGException
    {
        ...
        AiCrewMemberRemovalChooser chooser = new AiCrewMemberRemovalChooser(campaign);
        CrewMember companyMemberRemoved = chooser.findAiCrewMemberToRemove("Kapitan", TestIdentifiers.TEST_RUSSIAN_COMPANY_ID);
