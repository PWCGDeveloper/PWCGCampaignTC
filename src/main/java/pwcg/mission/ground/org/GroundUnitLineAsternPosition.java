...
public class GroundUnitLineAsternPosition
{
                                                               ...
                                                               int numVehicles) throws PWCGException 
    {
        ...
        Coordinate vehicleCoords = startCoords.copy();       
        
        // Direction in which subsequent units will be placed
        double lineAsternOrientation = initialPlacementAngle;             
        for (int i = 0; i < numVehicles; ++i)
        {   
            vehicleCoords = MathUtils.calcNextCoord(startCoords, lineAsternOrientation, unitSpacing * i);
