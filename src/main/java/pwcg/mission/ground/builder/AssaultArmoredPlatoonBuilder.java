...
public class AssaultArmoredPlatoonBuilder
{
    public static GroundUnitCollection generateAssault(Mission mission, GroundUnitCollection assaultFixedUnitCollection) throws PWCGException
    {
        ...
        GroundUnitCollection armoredUnits = buildArmoredUnits(mission, assaultDefinition, primaryAssaultSegmentGroundUnits);
    ...
    private static GroundUnitCollection buildFixedUnits(Mission mission, AssaultDefinition assaultDefinition, List<IGroundUnit> primaryAssaultSegmentGroundUnits) throws PWCGException
    {
    ...
    private static GroundUnitCollection buildArmoredUnits(Mission mission, AssaultDefinition assaultDefinition, List<IGroundUnit> primaryAssaultSegmentGroundUnits) throws PWCGException
    {
        AssaultFixedUnitBuilder assaultUnitBuilder = new AssaultFixedUnitBuilder(mission, assaultDefinition);
        GroundUnitCollection assaultUnits = assaultUnitBuilder.generateAssaultUnits();
        primaryAssaultSegmentGroundUnits.add(assaultUnits.getPrimaryGroundUnit());
