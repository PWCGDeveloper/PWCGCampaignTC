...
public class GAZAAAPayload extends TankPayload implements ITankPayload
{
    public GAZAAAPayload(TankTypeInformation tankType, Date date)
    {
        super(tankType, date);
    }
    ...
    {
        GAZAAAPayload clone = new GAZAAAPayload(getTankType(), getDate());
