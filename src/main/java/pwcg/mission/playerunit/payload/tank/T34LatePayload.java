...
public class T34LatePayload extends TankPayload implements ITankPayload
{
    public T34LatePayload(TankTypeInformation tankType, Date date)
    {
        super(tankType, date);
    }
    ...
    {
        T34LatePayload clone = new T34LatePayload(getTankType(), getDate());
