...
public class PzkwIVGPayload extends TankPayload implements ITankPayload
{
    public PzkwIVGPayload(TankTypeInformation tankType, Date date)
    {
        super(tankType, date);
    }
    ...
    {
        PzkwIVGPayload clone = new PzkwIVGPayload(getTankType(), getDate());
