...
public class CampaignCompanyLogDetailPageBuilder
{
    ...
    public CampaignCompanyLogDetailPageBuilder (int logsForCompanyId)
	{        
    ...
    public Map<Integer, StringBuffer> buildDetailPages()
	{
		...
		{            
			...
			{
				companyDetailPages.put(pageCount, page);
				++pageCount;
			...
			{
        	    if (logEntry.getCompanyId() != logsForCompanyId)
        	    {
        	        continue;
        	    }
