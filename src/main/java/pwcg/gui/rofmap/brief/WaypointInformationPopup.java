...
public class WaypointInformationPopup extends JPopupMenu
{
    ...
    private String formWaypointInfoText(int selectedMapPointIndex) throws PWCGException
	{
        ...
        for (BriefingMapPoint briefingMapPoint : BriefingContext.getInstance().getBriefingData().getActiveBriefingMapPlatoon().getBriefingPlatoonParameters().getBriefingMapMapPoints())
        {
